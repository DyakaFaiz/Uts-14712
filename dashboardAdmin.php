...
<body>
    <nav class="navbar shadow nav flex-column flex-sm-row bg-primary text-center">
        <a class="flex-sm-fill shadow-sm text-sm-start nav-link rounded bg-light disabled ms-sm-4" aria-current="page" href="#">Dashboard</a>
    ...
    <div class="container">
        <div class="p-5 row g-3">
            ...
            <div class="col col-md-6">
                <div class="card text-center">
                    <a href="barangAdmin/pageBarang.php">
                        <div class="card-body">
                            <i class="bi bi-box"></i>
                        </div>
                    </a>
